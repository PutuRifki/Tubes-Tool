...
<nav class="navbar navbar-white text-light stickSy-fixed">
    ...
    <div class="container my-5">
        <h2>List Karyawan</h2>
        <a href="createTabelKaryawan.php" class="btn btn-primary" role="button">New Karyawan</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[email]</td>
                            <td>
                                <a href='editTabelKaryawan.php?id=$row[id_karyawan]' class='btn btn-primary btn-sm'>Edit</a>
                                <a href='deleteTabelKaryawan.php?id=$row[id_karyawan]' class='btn btn-danger btn-sm'>Delete</a>
                            </td>
                    </tr>
                    ";
                }
