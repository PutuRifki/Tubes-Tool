...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    do{
        if(empty($id) || empty($username) || empty($password) || empty($umur) || empty($alamat)){
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE users " .
        "SET username = '$username', pass = '$password', umur = '$umur', alamat = '$alamat' " . 
        "WHERE id = $id";
...
<nav class="navbar navbar-white text-light stickSy-fixed">
    ...
    <div class="container my-5">
        ...
        <form action="" method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Password Hash</label>
                <div class="col-sm-6">
