...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do{
        if(empty($nama) || empty($noHp) || empty($alamat) || empty($jabatan) || empty($email)){
            $errorMessage = 'All the fields are required';
            break;
        }

        //add new client to database
        $sql = "INSERT INTO tb_karyawan (nama_karyawan, no_hp, alamat, jabatan, email)" . "VALUES ('$nama', '$noHp', '$alamat', '$jabatan', '$email')";
