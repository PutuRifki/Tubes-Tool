...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do{
        if(empty($nama) || empty($harga) || empty($jumlah_produk) || empty($total_harga)){
            $errorMessage = 'All the fields are required';
            break;
        }

        //add new client to database
        $sql = "INSERT INTO users (nama, harga, jumlah_produk, total_harga)" . "VALUES ('$nama', '$harga', '$jumlah_produk', '$total_harga')";
