...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    $sql = "SELECT * FROM tranksaksi WHERE id_tranksaksi ='$id'";
    ...
    $id_tranksaksi = $row["id_tranksaksi"];
    $nama = $row["nama"];
    $harga = $row["harga"];
    ...
    do{
        if(empty($id_tranksaksi) || empty($nama) || empty($harga) || empty($jumlah_produk) || empty($total_harga)){
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE tranksaksi " .
        "SET nama = '$nama', harga = '$harga', jumlah_produk = '$jumlah_produk', total_harga = '$total_harga' " . 
        "WHERE id = $id";
...
<nav class="navbar navbar-white text-light stickSy-fixed">
    ...
    <div class="container my-5">
        ...
        <form action="" method="post">
            <input type="hidden" name="id" value="<?php echo $id_tranksaksi; ?>">
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Id Tranksaksi</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="id_tranksaksi" value="<?php echo $id_tranksaksi; ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="jumlah_produk" value="<?php echo $jumlah_produk; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Total Harga</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="jumlah_produk" value="<?php echo $total_harga; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a href="tabelTranksaksi.php" class="btn btn-primary" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
