...
<nav class="navbar navbar-white text-light stickSy-fixed">
    ...
    <div class="container my-5">
        <h2>List Customer</h2>
        <a href="createTabelUser.php" class="btn btn-primary" role="button">Tambah Customer</a>
        <br>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Username</th>
                    <th class="col-5">Password Hash</th>
                    <th>Umur</th>
                    <th>Alamat</th>
                </tr>
            </thead>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[alamat]</td>
                            ...
                            <td>
                                <a href='editTabelUser.php?id=$row[id]' class='btn btn-primary btn-sm'>Edit</a>
                                <a href='deleteTabelUser.php?id=$row[id]' class='btn btn-danger btn-sm'>Delete</a>
                            </td>
                    </tr>
                    ";
                }
